...
import chennaicitytrafficapplication.prematix.com.etownpublic.model.Grievance.TrackGrievanceBean;
...
public class GrievancesTrackHelpher {
    ...
    ArrayList<TrackGrievanceBean> mGrievanceBeans = new ArrayList<>();

    private GrievancesTrackHelpher(Activity activity) {
        this.activity = activity;
    }

    public static GrievancesTrackHelpher getInstance(Activity activity) {
        if (grievancesTrackHelpher == null) {
            grievancesTrackHelpher = new GrievancesTrackHelpher(activity);
        }
                    ...
                    if (jsonArray.length() > 0) {
                        ...
                        if (grievanceArray.length() > 0) {
                            for (int i = 0; i < grievanceArray.length(); i++) {
                                ...
                                mGrievanceBeans.add(new TrackGrievanceBean(mGrivno, mCompDate, mDistrict, mPanchayat, mComplaintType,
    ...
    public void searchGrievance(String s) {
        ...
        ArrayList<TrackGrievanceBean> filterdlist = new ArrayList<>();
    ...
    public void alertShowGriveance(final List<TrackGrievanceBean> data_list) {
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(activity);
        View v2 = activity.getLayoutInflater().inflate(R.layout.alert_griveance, null);
        final EditText et_search = v2.findViewById(R.id.et_search);
        final LinearLayout rv_linear = v2.findViewById(R.id.rv_linear);
        ...
        RecyclerView recyclerView = v2.findViewById(R.id.rv_grievances);
    ...
    public void showSpecificDetail(int pos) {
        ...
        TextView tv_grivno = v2.findViewById(R.id.tv_grivno);
        TextView tv_district = v2.findViewById(R.id.tv_district);
        TextView tv_panchayat = v2.findViewById(R.id.tv_panchayat);
        TextView tv_name = v2.findViewById(R.id.tv_name);
        TextView tv_doorno = v2.findViewById(R.id.tv_doorno);
        TextView tv_wardno = v2.findViewById(R.id.tv_wardno);
        TextView tv_streetname = v2.findViewById(R.id.tv_streetname);
        TextView tv_comptype = v2.findViewById(R.id.tv_comptype);
        TextView tv_description = v2.findViewById(R.id.tv_description);
