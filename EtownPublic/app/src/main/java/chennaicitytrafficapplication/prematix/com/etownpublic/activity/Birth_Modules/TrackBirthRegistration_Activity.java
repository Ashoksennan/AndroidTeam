...
public class TrackBirthRegistration_Activity extends AppCompatActivity implements TrackBirthRegistration_Adapter.SpecificDetails {
    ...
    ArrayList<chennaicitytrafficapplication.prematix.com.etownpublic.model.Birth_Death.TrackBirthRegistration_Pojo> beanlist;
                    ...
                    if(jsonArray.length()>0){
                        ...
                        if(trackArray.length()>0){
                            for(int i=0;i<trackArray.length();i++){
                                ...
                                beanlist.add(new chennaicitytrafficapplication.prematix.com.etownpublic.model.Birth_Death.TrackBirthRegistration_Pojo(trackObjects.optString("RequestNo"),trackObjects.getString("RequestDate"),
